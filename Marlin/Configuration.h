...
#define CUSTOM_MACHINE_NAME "Monoprice Maker Select"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 146.68
  #define DEFAULT_bedKi 28.05
  #define DEFAULT_bedKd 511.41
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 8, 7, 0.6, 10 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31, -47, -2.00 }
